...
export default function PostContent({ post }) {
  ...
  return (
    <div className="mt-4 mx-4 p-2 text-left border-2 border-gray-200 rounded-lg bg-gray-100">
      <h1 className='mt-6 mb-4 mx-4  text-3xl font-extrabold font-CircularMedium'>{post?.title}</h1>
