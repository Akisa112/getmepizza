        ...
        <section className='lg:max-w-4xl lg:mx-auto  text-gray-800 dark:text-slate-300'>
          <div className='mx-6 mt-8'>
            <p className=''>
              ...
              our platform. The services are provided by Get Me Pizza, a South
              African sole prop run by @elonsdev. It is Get Me Pizza’s policy to
            ...
            <p className=''>
              ...
              computer or device depends on what it is and what it is used for.
              Some Google Analytics cookies expire at the end of your browser
              session, whilst others can remain for up to two years. You can
              prevent your data from being collected by Google Analytics on our
            ...
            <p className=''>
              ...
              otherwise different from the laws in effect in the country in
              which you are located. Where we transfer your Personal Data out of
              the EU we will take steps to ensure that your Personal Data
              receives an adequate level of protection where it is processed and
              your rights continue to be protected (GDPR). By providing your
              information to the Services you agree to the transfer of your
